	...
	public partial class cBulletForm : Form
		...
		private void UpdateButtons()
			...
			foreach (cCaliber CheckCaliber in m_DataFiles.CaliberList)
				...
				if (ManufacturerCombo.SelectedIndex != -1 &&
					CheckCaliber.FirearmType == FirearmTypeCombo.Value &&
					dBulletDiameter >= Math.Round(CheckCaliber.MinBulletDiameter, m_DataFiles.Preferences.DimensionDecimals) &&
					dBulletDiameter <= Math.Round(CheckCaliber.MaxBulletDiameter, m_DataFiles.Preferences.DimensionDecimals) &&
