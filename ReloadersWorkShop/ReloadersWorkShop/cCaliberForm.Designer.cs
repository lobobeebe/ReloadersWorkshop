...
namespace ReloadersWorkShop
	...
	partial class cCaliberForm
		...
		private void InitializeComponent()
			...
			this.CaliberOKButton = new System.Windows.Forms.Button();
			this.CaliberCancelButton = new System.Windows.Forms.Button();
			...
			// CaliberOKButton
			// 
			this.CaliberOKButton.DialogResult = System.Windows.Forms.DialogResult.OK;
			this.CaliberOKButton.Location = new System.Drawing.Point(144, 307);
			this.CaliberOKButton.Margin = new System.Windows.Forms.Padding(2);
			this.CaliberOKButton.Name = "CaliberOKButton";
			this.CaliberOKButton.Size = new System.Drawing.Size(56, 19);
			this.CaliberOKButton.TabIndex = 2;
			this.CaliberOKButton.Text = "OK";
			this.CaliberOKButton.UseVisualStyleBackColor = true;
			// 
			// CaliberCancelButton
			// 
			this.CaliberCancelButton.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.CaliberCancelButton.Location = new System.Drawing.Point(219, 307);
			this.CaliberCancelButton.Margin = new System.Windows.Forms.Padding(2);
			this.CaliberCancelButton.Name = "CaliberCancelButton";
			this.CaliberCancelButton.Size = new System.Drawing.Size(56, 19);
			this.CaliberCancelButton.TabIndex = 3;
			this.CaliberCancelButton.Text = "Cancel";
			this.CaliberCancelButton.UseVisualStyleBackColor = true;
			// 
			// GeneralGroupBox
			// 
			...
			this.MaxBulletWeightTextBox.MinValue = 20D;
			...
			this.MinBulletWeightTextBox.MinValue = 20D;
			...
			// cCaliberForm
			// 
			this.AcceptButton = this.CaliberOKButton;
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.CancelButton = this.CaliberCancelButton;
			this.ClientSize = new System.Drawing.Size(389, 345);
			this.ControlBox = false;
			this.Controls.Add(this.groupBox2);
			this.Controls.Add(this.GeneralGroupBox);
			this.Controls.Add(this.CaliberCancelButton);
			this.Controls.Add(this.CaliberOKButton);
		...
		private System.Windows.Forms.Button CaliberOKButton;
		private System.Windows.Forms.Button CaliberCancelButton;
